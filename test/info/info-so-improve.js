...
const DATA_PATH = path.join(BASE, "data/soFixesImprove.json");
const EXAMPLE_PATH = path.join(BASE, "data/examples/SOExamples-improved.json");

// create logger
const logger = winston.createLogger();
var filename = path.join(
    INFO_LOG_DIR,
    "soImproved" + Date.now() + ".log",
);
...
describe("SO Edits (Improved) (long run time)", function () {
